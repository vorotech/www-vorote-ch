...
| ----------------------- | ---------------------------------------------------- | --------------------------------------------------- |
| _Input/Output Boundary_ | Clearly defined (form data, API parameters)          | Blurred (uses natural language)                     |
| _Reaction to Payload_   | Deterministic (same request yields identical result) | Non-deterministic (generation can constantly vary)  |
| _Defense Maturity_      | Well-studied (escaping, typing, parameterization)    | Under development (contextual analysis, guardrails) |
| _Exploitation Vector_   | Exploitation of syntactical parser                   | Exploitation of semantic perception of the model    |
