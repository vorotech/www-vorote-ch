...
<FeaturedLink
  ...
  title="Prowler"
  description={<>
    Open Cloud Security platform for AWS, Azure, GCP, Kubernetes, M365 and more. It helps for continuos monitoring, security assessments and audits, incident response, compliance, hardening and forensics readiness.
  </>}
  url="https://github.com/prowler-cloud/prowler/"
  bannerImage="/uploads/posts/Designer_001.jpeg"
/>
