      ...
      <Section className='py-20 relative overflow-hidden'>
        ...
        {post.heroImg && (
          <div className='absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-6xl h-[600px] -z-10 pointer-events-none select-none'>
            ...
            <div className='absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[500px] blur-[140px] opacity-20 dark:opacity-15 rounded-full overflow-hidden'>
              <Image src={post.heroImg} alt='' fill sizes='(max-width: 768px) 100vw, 80vw' className='object-cover scale-150' />
            </div>
            ...
            <div className='absolute top-20 left-1/2 -translate-x-1/2 w-[400px] h-[300px] blur-[80px] opacity-40 dark:opacity-25 rounded-full overflow-hidden animate-pulse duration-[10s]'>
              <Image src={post.heroImg} alt='' fill sizes='(max-width: 768px) 100vw, 80vw' className='object-cover scale-110 saturate-150' />
            </div>
          </div>
        )}
        ...
        <div className='max-w-4xl mx-auto px-4 relative'>
          <h1
            ...
            className='w-full relative mb-10 text-5xl md:text-7xl font-extrabold tracking-tight text-center font-heading leading-tight drop-shadow-sm'
          >
          ...
          <div data-tina-field={tinaField(post, 'author')} className='flex items-center justify-center mb-16 space-x-8 border-y border-border/50 py-8'>
            {post.author && (
              <div className='flex items-center group'>
                ...
                <div className='flex flex-col'>
                  ...
                  <p data-tina-field={tinaField(post.author, 'name')} className='text-sm font-black text-foreground group-hover:text-primary transition-colors'>
                    {post.author.name}
                  </p>
                </div>
              </div>
            ...
            <div className='flex flex-col'>
              ...
              <p data-tina-field={tinaField(post, 'date')} className='text-sm font-bold text-foreground'>
                {formattedDate}
              </p>
            </div>
        ...
        <div className='max-w-3xl mx-auto px-4'>
          <div
            ...
            className='prose dark:prose-invert w-full max-w-none prose-headings:font-heading prose-headings:tracking-tight prose-p:leading-relaxed prose-pre:p-0 prose-img:rounded-2xl selection:bg-primary/20'
          >
            <TinaMarkdown
              content={post._body}
              components={{
