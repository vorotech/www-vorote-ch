    ...
    <Layout>
      <div className='container mx-auto px-6 py-12 max-w-6xl'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16'>
          <Link href='/tools/scheduler' className='group p-6 border rounded-xl hover:shadow-lg transition-all duration-300 bg-card hover:border-primary/50'>
          ...
          >
            ...
            <p className='text-muted-foreground mb-4'>Audit npm package dependencies for real-time security vulnerabilities and recommendations.</p>
            <div className='flex items-center text-sm font-medium text-primary group-hover:underline'>
              Open Tool <ArrowRight className='w-4 h-4 ml-1 transition-transform group-hover:translate-x-1' />
            </div>
          </Link>
