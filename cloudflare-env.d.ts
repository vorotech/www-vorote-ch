/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 123e2d57a58c6ee0be7ed2bd129a82bf)
// Runtime types generated with workerd@1.20251213.0 2025-03-01 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		NODE_OPTIONS: "--max-old-space-size=4096";
		ENABLE_EMAIL_SENDING: "true";
		SEND_FEEDBACK: SendEmail;
		ASSETS: Fetcher;
	}
}
