  ...
  return (
    ...
    >
      <div className='absolute right-0 top-0 z-20 flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity'>
        <Button variant='secondary' size='icon' className='h-8 w-8 rounded-full shadow-md' onClick={() => setIsFullScreen(!isFullScreen)}>
      ...
      {isFullScreen && <div className='mt-4 text-center text-sm text-muted-foreground'>Click the minimize icon or press ESC to exit full screen view.</div>}
    </div>
  );
};
