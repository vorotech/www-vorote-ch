      ...
      <div className='relative overflow-hidden flex flex-col lg:block mx-auto max-w-7xl'>
            ...
            {data.headline && (
              <div data-tina-field={tinaField(data, 'headline')}>
                <TextEffect
                  ...
                  speedSegment={0.3}
                  as='h1'
                  className='text-balance text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight text-foreground'
                >
                  {data.headline!}
                </TextEffect>
              </div>
              ...
              {data.actions &&
                data.actions.map((action) => (
                  <div
                    ...
                    className='bg-background/50 backdrop-blur-sm rounded-[calc(var(--radius-xl)+0.125rem)] border p-0.5 shadow-sm'
                  >
        ...
        <div className='relative w-full h-[50vh] min-h-[300px] lg:absolute lg:inset-y-0 lg:right-0 lg:h-full lg:w-[55%] order-1 lg:order-none overflow-hidden'>
          ...
          <div className='hidden lg:block w-full h-full relative'>
            ...
            >
              <Image className='object-cover object-left-top h-full w-full' alt={data.image?.alt || 'Portrait'} src={imageSrc} fill sizes='55vw' priority />
            </div>
