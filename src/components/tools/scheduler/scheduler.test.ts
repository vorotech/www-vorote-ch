  ...
  },
  {
    ...
    config: {
      ...
      members: [
        ...
        { id: 2, name: 'Person 2', timeOffs: [], weekendOnly: false, maxWeekendSlots: null, allowedWeekdays: [] },
        { id: 3, name: 'Person 3', timeOffs: [], weekendOnly: false, maxWeekendSlots: null, allowedWeekdays: [] },
        { id: 4, name: 'Person 4', timeOffs: [], weekendOnly: false, maxWeekendSlots: null, allowedWeekdays: [] },
        { id: 5, name: 'Person 5', timeOffs: [], weekendOnly: false, maxWeekendSlots: 3, allowedWeekdays: [] },
        { id: 6, name: 'Person 6', timeOffs: [], weekendOnly: true, maxWeekendSlots: 3, allowedWeekdays: [] },
        { id: 7, name: 'Person 7', timeOffs: [], weekendOnly: false, maxWeekendSlots: null, allowedWeekdays: [] },
      ],
    },
  },
