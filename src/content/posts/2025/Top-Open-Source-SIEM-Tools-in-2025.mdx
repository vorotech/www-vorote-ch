...
<FeaturedLink
  ...
  title="Wazuh"
  icon="cyber"
  description="Open Source XDR and SIEM. Endpoint security, log data analysis, and cloud security monitoring."
/>
...
<FeaturedLink
  ...
  title="OpenSearch"
  icon="report"
  description="Flexible, scalable, open-source search and analytics suite."
/>
...
<FeaturedLink
  ...
  icon="cyber"
  description="Free and open source Linux distribution for threat hunting, enterprise security monitoring, and log management."
/>
...
<FeaturedLink
  ...
  title="Graylog"
  icon="report"
  description="Centralized log management and SIEM platform for security and IT operations."
/>
...
<FeaturedLink
  ...
  title="Sigma HQ"
  icon="tools"
  description="Generic signature format for SIEM systems. detection rules as code."
/>
...
<FeaturedLink
  ...
  title="Malcolm"
  icon="cyber"
  description="Powerful, easily deployable network traffic analysis tool suite."
/>
